...
brokenMirrorScreen = imageScaling(0, 0, brokenMirror, 1)
...
BathroomMirrorScreen = imageScaling(0, 0, BathroomMirror, 1)
sinkScreen = imageScaling(0, 0, sinkImg, 3)
...
sinkWaterScreen = imageScaling(0, 0, sinkWater, 3)
    ...
    if event.type == pygame.MOUSEBUTTONDOWN and event.button == 1:
      ...
      if BathroomArea == False and bathroom == True:
        ...
        if sinkRect.collidepoint(x, y) and sink == False and mirror == False:
          ...
          if slotOneInsert == False or slotTwoInsert == False and slotThreeInsert == False:
            sinkScreen.draw()
          elif slotOneInsert == True and slotTwoInsert == True and slotThreeInsert == True:
            sinkWaterScreen.draw()
